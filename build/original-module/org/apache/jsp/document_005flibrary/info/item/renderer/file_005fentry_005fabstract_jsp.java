package org.apache.jsp.document_005flibrary.info.item.renderer;
...
public final class file_005fentry_005fabstract_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/document_library/info/item/renderer/init.jsp");
  }
...
FileVersion fileVersion = (FileVersion)request.getAttribute(WebKeys.DOCUMENT_LIBRARY_FILE_VERSION);
	...
	if (Objects.equals(fileEntry.getVersion(), fileVersion.getVersion())) {
		if (ImageProcessorUtil.hasImages(fileVersion)) {
          ...
          out.write("\n\n\t<div class=\"aspect-ratio aspect-ratio-8-to-3 aspect-ratio-bg-cover cover-image mb-4\" style=\"background-image: url(");
